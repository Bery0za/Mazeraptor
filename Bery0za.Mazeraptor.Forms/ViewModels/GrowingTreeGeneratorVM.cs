...
namespace Bery0za.Mazerator.Forms.ViewModels
{
    public class GrowingTreeGeneratorVM : ViewModel, IGeneratorVM
    {
        ...
        public PropertyWrapper<CellSelector> CarvingCellSelector = new PropertyWrapper<CellSelector>(CellSelector.Random);
        ...
        {
            return new GrowingTreeGenerator(GeneratorSelectorVM.CreateCellSelector(FirstCellSelector.Value, FirstCellParameter.Value),
                                            GeneratorSelectorVM.CreateCellSelector(CarvingCellSelector.Value, CarvingCellParameter.Value),
                                            GeneratorSelectorVM.CreateCellSelector(LeftCellSelector.Value, LeftCellParameter.Value),
